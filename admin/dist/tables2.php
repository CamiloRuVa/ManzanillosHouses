                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edicion.php?id=<?php echo $row["id"]; ?>">Editar</a> |
                                                    <a href="prose_elim.php?id=<?php echo $row["id"]; ?>" class="table__item__link">Eliminar</a>
                                                </td> 
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row["nombre"]; ?></td>
                                                <td>
                                                    <a href="edicion2.php?id=<?php echo $row["id"]; ?>">Editar</a> |
                                                    <a href="prose_elim2.php?id=<?php echo $row["id"]; ?>">Eliminar</a>
                                                </td> 
